...
- Uses OpenRouter API (OpenAI-compatible) with `deepseek/deepseek-v4-flash:free` model
- Env var: `OPENROUTER_API_KEY` — get from https://openrouter.ai
